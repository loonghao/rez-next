...
class TestModuleImports:
    ...
    def test_main_module_imports(self):
        ...
        expected_attrs = [
            'Version', 'VersionRange', 'parse_version', 'parse_version_range',
            'VersionToken', 'NumericToken', 'AlphanumericVersionToken',
            'Config', 'RezCoreConfig', '__version__', '__author__', '__email__'
        ]
    ...
    def test_all_exports(self):
        ...
        for item in rez_core.__all__:
            assert hasattr(rez_core, item), f"__all__ contains {item} but it's not available"
...
class TestErrorsModule:
    ...
    def test_error_classes_inheritance(self):
        ...
        from rez_core.errors import VersionError, RangeParseError, TokenError
        import rez_core
    ...
    def test_handle_version_error_decorator(self):
        ...
        from rez_core.errors import handle_version_error, VersionError, RangeParseError, TokenError
        import rez_core
    ...
    def test_error_module_exports(self):
        ...
        for item in errors.__all__:
            assert hasattr(errors, item), f"errors.__all__ contains {item} but it's not available"
...
class TestTokensModule:
    ...
    def test_tokens_module_exports(self):
        ...
        for item in tokens.__all__:
            assert hasattr(tokens, item), f"tokens.__all__ contains {item} but it's not available"
...
class TestVersionModule:
    ...
    def test_version_module_exports(self):
        ...
        for item in version.__all__:
            assert hasattr(version, item), f"version.__all__ contains {item} but it's not available"
