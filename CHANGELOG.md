...
- **build/systems/python**: Add mock integration tests for `PythonBuildSystem`
...
- **build/systems/nodejs**: Add mock integration tests for `NodeJsBuildSystem`
  - `test_package_always_succeeds` — static packaging result
...
- **build/systems/cargo_build**: Add integration tests for `CargoBuildSystem`
...
- **build/systems/mod**: Add 10 `detect` / `detect_with_package` integration tests using real `tempdir`
