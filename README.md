...
```bash
REZ_NEXT_VERSION=0.3.8 curl -fsSL https://raw.githubusercontent.com/loonghao/rez-next/main/install.sh | sh # x-release-please-version
```
...
|---|---|---|
| `REZ_NEXT_VERSION` | Version to install (e.g. `0.3.8`) | latest | <!-- x-release-please-version -->
...
rez-next self-update --version 0.3.8 # x-release-please-version
