...
use rez_core_package::{
    ...
    PackageInstallOptions, PackageCopyOptions
};
...
fn test_package_creation() {
    ...
    println!("   Package version: {}", 
             package.version.as_ref().map(|v| v.as_str()).unwrap_or("None"));
...
fn test_validation_options() {
    ...
    println!("   Default check_metadata: {}", default_options.check_metadata);
    println!("   Default check_dependencies: {}", default_options.check_dependencies);
    ...
    println!("   Quick check_dependencies: {}", quick_options.check_dependencies);
