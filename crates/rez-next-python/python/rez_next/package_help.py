...
class PackageHelp:
    ...
    def __init__(self, package_name: str, version_range: Optional[str] = None, paths=None, verbose: bool = False) -> None:
        """
    ...
    def open(self, section_index: int = 0) -> None:
        ...
        if section_index >= len(self._sections):
            raise IndexError(f"Section index {section_index} out of range (0-{len(self._sections)-1})")
