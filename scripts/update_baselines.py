...
class BaselineManager:
    ...
    def update_baselines(self, benchmark_dir: Path, baseline_dir: Path, 
                        commit_hash: str, force: bool = False) -> bool:
...
def main():
    ...
    parser.add_argument("--commit-hash", required=True,
                       help="Git commit hash for this update")
    parser.add_argument("--force", action="store_true",
                       help="Force update without creating backup")
    parser.add_argument("--list", action="store_true",
                       help="List current baselines and exit")
    parser.add_argument("--clean-backups", type=int, metavar="N",
