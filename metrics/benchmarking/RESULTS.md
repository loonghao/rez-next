...
> ⚠️ **7 regression(s) detected**: `package_deserialization/simple_json`, `package_deserialization/complex_json`, `package_deserialization/simple_python`, `package_deserialization/complex_python`, `package_deserialization/large_python`, `package_variants/add_variants/50`, `package_requirements/add_requirements/1`

## Environment

| Field | Value |
|-------|-------|
| rez-next commit | `ddb674c` |
| Generated | 2026-09-25 22:30 UTC |
...
|-----------|-----------|---------------|---------|----------------|
| 1000× Version.parse() in Python rez | 12.0 ms | 513.3 ns | **~23378×** | `version_parsing` |
| 1000× VersionRange creation in Python rez | 18.0 ms | N/A | N/A | `—` |
| 1000× Requirement/PackageRequest in Python rez | 25.0 ms | 150.4 ns | **~166234×** | `package_requirements/add_requirements/1` |
| 10-command Rex block execution in Python rez | 5.0 ms | 21.50 µs | **~233×** | `rex_execute_commands_block/execute/maya` |
| Generate bash activation script in Python rez | 15.0 ms | N/A | N/A | `—` |
| Parse a 50-line package.py in Python rez | 8.0 ms | 14.11 µs | **~567×** | `package_serialization/simple_yaml` |
...
|--------|-------------|-----------------|---------|
| Median solve time | 41.0 ms | 29.5 ns | **~1391×** |
