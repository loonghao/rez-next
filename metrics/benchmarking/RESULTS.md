...
<!-- Last updated: 2026-09-26 02:12 UTC -->
<!-- Commit: 497a179 -->

# rez-next Performance Results


> ⚠️ **4 regression(s) detected**: `package_serialization/complex_json`, `package_deserialization/large_yaml`, `package_deserialization/simple_python`, `package_deserialization/large_python`

## Environment

| Field | Value |
|-------|-------|
| rez-next commit | `497a179` |
...
|-----------|-----------|---------------|---------|----------------|
| 1000× Version.parse() in Python rez | 12.0 ms | 486.6 ns | **~24662×** | `version_parsing` |
| 1000× VersionRange creation in Python rez | 18.0 ms | N/A | N/A | `—` |
| 1000× Requirement/PackageRequest in Python rez | 25.0 ms | 139.4 ns | **~179276×** | `package_requirements/add_requirements/1` |
| 10-command Rex block execution in Python rez | 5.0 ms | 20.67 µs | **~242×** | `rex_execute_commands_block/execute/maya` |
...
|--------|-------------|-----------------|---------|
| Median solve time | 41.0 ms | 28.7 ns | **~1428×** |
