...
<!-- Last updated: 2026-09-24 05:26 UTC -->
<!-- Commit: 000ac45 -->

# rez-next Performance Results


> ⚠️ **5 regression(s) detected**: `package_serialization/simple_python`, `package_deserialization/simple_yaml`, `package_deserialization/large_yaml`, `package_validation/large_valid`, `package_cloning/large_clone`

## Environment

| Field | Value |
|-------|-------|
| rez-next commit | `000ac45` |
| Generated | 2026-09-24 05:26 UTC |
...
|-----------|-----------|---------------|---------|----------------|
| 1000× Version.parse() in Python rez | 12.0 ms | 506.2 ns | **~23707×** | `version_parsing` |
...
| 10-command Rex block execution in Python rez | 5.0 ms | 19.76 µs | **~253×** | `rex_execute_commands_block/execute/maya` |
| Generate bash activation script in Python rez | 15.0 ms | N/A | N/A | `—` |
| Parse a 50-line package.py in Python rez | 8.0 ms | 14.17 µs | **~564×** | `package_serialization/simple_yaml` |
