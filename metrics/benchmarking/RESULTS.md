...
> ⚠️ **5 regression(s) detected**: `package_serialization/large_yaml`, `package_serialization/simple_json`, `package_serialization/large_json`, `package_deserialization/large_yaml`, `package_deserialization/large_python`

## Environment

| Field | Value |
|-------|-------|
| rez-next commit | `71e1d70` |
| Generated | 2026-09-23 09:58 UTC |
...
|-----------|-----------|---------------|---------|----------------|
| 1000× Version.parse() in Python rez | 12.0 ms | 277.2 ns | **~43290×** | `version_parsing` |
| 1000× VersionRange creation in Python rez | 18.0 ms | N/A | N/A | `—` |
| 1000× Requirement/PackageRequest in Python rez | 25.0 ms | 74.2 ns | **~336864×** | `package_requirements/add_requirements/1` |
| 10-command Rex block execution in Python rez | 5.0 ms | 11.62 µs | **~430×** | `rex_execute_commands_block/execute/maya` |
| Generate bash activation script in Python rez | 15.0 ms | N/A | N/A | `—` |
| Parse a 50-line package.py in Python rez | 8.0 ms | 6.95 µs | **~1152×** | `package_serialization/simple_yaml` |
...
|--------|-------------|-----------------|---------|
| Median solve time | 41.0 ms | 28.0 ns | **~1466×** |
