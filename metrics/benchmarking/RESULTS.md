...
<!-- Last updated: 2026-07-19 05:43 UTC -->
<!-- Commit: 12b29eb -->

# rez-next Performance Results


> ⚠️ **8 regression(s) detected**: `package_serialization/simple_yaml`, `package_serialization/complex_json`, `package_serialization/simple_python`, `package_variants/add_variants/10`, `package_cloning/simple_clone`, `package_requirements/add_requirements/50`, `package_requirements/add_build_requirements/10`, `package_requirements/add_build_requirements/100`

## Environment

| Field | Value |
|-------|-------|
| rez-next commit | `12b29eb` |
...
|-----------|-----------|---------------|---------|----------------|
| 1000× Version.parse() in Python rez | 12.0 ms | 525.7 ns | **~22826×** | `version_parsing` |
| 1000× VersionRange creation in Python rez | 18.0 ms | N/A | N/A | `—` |
| 1000× Requirement/PackageRequest in Python rez | 25.0 ms | 153.7 ns | **~162623×** | `package_requirements/add_requirements/1` |
...
| Parse a 50-line package.py in Python rez | 8.0 ms | 13.87 µs | **~577×** | `package_serialization/simple_yaml` |
...
|--------|-------------|-----------------|---------|
| Median solve time | 41.0 ms | 32.3 ns | **~1268×** |
